                ...
                <div className={styles['user-card']}>
                    <div className={styles['profile-pic']}>
                        <div className={styles['centerer']}>
                            ...
                            <img src={Johnny} alt="User Profile" />
                        </div>
                    </div>
                    <div className={styles['edit-button-box']}>
                        <Link to="/userProfile" className={styles['edit-button']}>
                            <p>SAVE PROFILE</p>
                        </Link>
                    </div>
                        ...
                        <div className={styles['user-info-box']}>
                            <div className={styles['input-field']}>
                                ...
                                <div className={styles['input-field-select']}>
                                    <select id="Region" size={1} defaultValue="defaultOption">
                                        <option value="">Select Region</option>
                                    </select>
                                    <select id="City" size={1}  defaultValue="defaultOption">
                                        <option value="defaultOption" >Select City</option>
                                    </select>
                                </div>
                                <div className={styles['input-field-select-rowtwo']}>
                                    <select id="Barangay" size={1}  defaultValue="defaultOption">
                                        <option value="defaultOption">Select Barangay</option>
                                    </select>
