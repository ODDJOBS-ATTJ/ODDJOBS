...
function WorkerProfileEdit() {
  return (
    <>
      <SignedInHeader />
      <Link to="/worker-profile" onClick={() => window.history.back()} className={Styles['back-button']}> ← Back</Link>
      <Link to="/worker-profile" className={Styles['edit-button']}>SAVE PROFILE</Link>
