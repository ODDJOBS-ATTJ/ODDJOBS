...
import samplePhoto from '../Customer/IMAGE/Icons/samplePhoto.png';
        ...
        <div>
            ...
            <div className={bookings['container']}>
                <div className={bookings['booking-container']}>
                    ...
                    <table>
                        <tbody>
                            <Link to='/worker/bookings/ongoing'>
                                <tr>
                            ...
                            <Link to='/worker/bookings/approved'>
                                <tr>
                                    <td className={bookings['image']}>
                            ...
                            <Link to='/worker/bookings/pending'>
                                <tr>
                                    <td className={bookings['image']}>
                                        <img src={samplePhoto} alt="Sample" />
                                    </td>
                    ...
                    <table>
                        <tbody>
                            <Link to='/worker/bookings/completed'>
                                <tr>
                                    <td className={bookings['image']}>
                                        <img src={samplePhoto} alt="Sample" />
                                    </td>
                                    ...
                                    <td className={bookings['status-160']}>
                                        <h2>Completed</h2>
                                    </td>
                                    <td className={bookings['price']}>
                                        <h2>total price: ₱2500.00</h2>
                    ...
                    <table>
                        <tbody>
                            <Link to='/worker/bookings/cancelled'>
                                <tr>
                                    <td className={bookings['image']}>
                                        <img src={samplePhoto} alt="Sample" />
                                    </td>
